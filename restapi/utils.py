...
def multi_threaded_reader(urls, num_threads) -> list:
        """Read multiple files through HTTP and optimized using thread pooling"""
    result = []
    with ThreadPoolExecutor(max_workers=num_threads) as executor:
        future_to_url = {executor.submit(reader, url, constants.READER_TIMEOUT): url for url in URLS}
